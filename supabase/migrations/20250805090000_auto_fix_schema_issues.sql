...
--ALTER TABLE enhanced_job_searches ADD COLUMN IF NOT EXISTS id UUID;
ALTER TABLE enhanced_job_searches ADD COLUMN IF NOT EXISTS user_id UUID;
ALTER TABLE enhanced_job_searches ADD COLUMN IF NOT EXISTS profile_id UUID;
ALTER TABLE enhanced_job_searches ADD COLUMN IF NOT EXISTS search_name TEXT;
...
ALTER TABLE enhanced_job_searches ADD COLUMN IF NOT EXISTS minimum_match_score DECIMAL(3,2);
...
ALTER TABLE enhanced_job_searches ADD COLUMN IF NOT EXISTS created_at  TIMESTAMP WITH TIME ZONE;
ALTER TABLE enhanced_job_searches ADD COLUMN IF NOT EXISTS updated_at  TIMESTAMP WITH TIME ZONE;

-- Add missing columns to job_board_sources
--ALTER TABLE job_board_sources ADD COLUMN IF NOT EXISTS id UUID;
ALTER TABLE job_board_sources ADD COLUMN IF NOT EXISTS name TEXT;
ALTER TABLE job_board_sources ADD COLUMN IF NOT EXISTS display_name TEXT;
ALTER TABLE job_board_sources ADD COLUMN IF NOT EXISTS website_url TEXT;
...
ALTER TABLE job_board_sources ADD COLUMN IF NOT EXISTS created_at  TIMESTAMP WITH TIME ZONE;
ALTER TABLE job_board_sources ADD COLUMN IF NOT EXISTS updated_at  TIMESTAMP WITH TIME ZONE;

-- Add missing columns to job_search_results
--ALTER TABLE job_search_results ADD COLUMN IF NOT EXISTS id UUID;
ALTER TABLE job_search_results ADD COLUMN IF NOT EXISTS search_id UUID;
ALTER TABLE job_search_results ADD COLUMN IF NOT EXISTS job_board_source_id UUID;
ALTER TABLE job_search_results ADD COLUMN IF NOT EXISTS job_title TEXT;
ALTER TABLE job_search_results ADD COLUMN IF NOT EXISTS company_name TEXT;
...
ALTER TABLE job_search_results ADD COLUMN IF NOT EXISTS job_url TEXT;
...
ALTER TABLE job_search_results ADD COLUMN IF NOT EXISTS created_at  TIMESTAMP WITH TIME ZONE;
ALTER TABLE job_search_results ADD COLUMN IF NOT EXISTS updated_at  TIMESTAMP WITH TIME ZONE;

-- Add missing columns to search_execution_log
--ALTER TABLE search_execution_log ADD COLUMN IF NOT EXISTS id UUID;
ALTER TABLE search_execution_log ADD COLUMN IF NOT EXISTS search_id UUID;
ALTER TABLE search_execution_log ADD COLUMN IF NOT EXISTS execution_type TEXT;
...
ALTER TABLE search_execution_log ADD COLUMN IF NOT EXISTS status TEXT;
...
ALTER TABLE search_execution_log ADD COLUMN IF NOT EXISTS created_at  TIMESTAMP WITH TIME ZONE;

-- Add missing columns to scraping_preferences
--ALTER TABLE scraping_preferences ADD COLUMN IF NOT EXISTS id UUID;
ALTER TABLE scraping_preferences ADD COLUMN IF NOT EXISTS user_id UUID;
...
ALTER TABLE scraping_preferences ADD COLUMN IF NOT EXISTS created_at  TIMESTAMP WITH TIME ZONE;
ALTER TABLE scraping_preferences ADD COLUMN IF NOT EXISTS updated_at  TIMESTAMP WITH TIME ZONE;

-- Add missing columns to scraping_request_log
--ALTER TABLE scraping_request_log ADD COLUMN IF NOT EXISTS id UUID;
ALTER TABLE scraping_request_log ADD COLUMN IF NOT EXISTS user_id UUID;
ALTER TABLE scraping_request_log ADD COLUMN IF NOT EXISTS job_board TEXT;
ALTER TABLE scraping_request_log ADD COLUMN IF NOT EXISTS status TEXT;
...
ALTER TABLE scraping_request_log ADD COLUMN IF NOT EXISTS created_at  TIMESTAMP WITH TIME ZONE;

-- Add missing columns to job_profiles
--ALTER TABLE job_profiles ADD COLUMN IF NOT EXISTS id UUID;
ALTER TABLE job_profiles ADD COLUMN IF NOT EXISTS user_id UUID;
ALTER TABLE job_profiles ADD COLUMN IF NOT EXISTS name TEXT;
ALTER TABLE job_profiles ADD COLUMN IF NOT EXISTS title TEXT;
...
ALTER TABLE job_profiles ADD COLUMN IF NOT EXISTS created_at  TIMESTAMP WITH TIME ZONE;
ALTER TABLE job_profiles ADD COLUMN IF NOT EXISTS updated_at  TIMESTAMP WITH TIME ZONE;
