-- Migration: Add task dependencies and task numbering system (FIXED)
-- Date: 2025-08-12
...
-- ==============================================
-- 4. GENERATE TASK NUMBERS FOR EXISTING TASKS (FIXED)
-- ==============================================
...
BEGIN
    ...
    LOOP
        ...
        FOR task_record IN 
            ...
            ORDER BY created_at
        LOOP
            current_task_counter := current_task_counter + 1;
            
            UPDATE tasks 
            SET task_number = (
                SELECT abbreviation || '-' || current_task_counter::text 
                FROM taskboards 
        ...
        UPDATE taskboards 
        SET task_counter = current_task_counter 
        WHERE id = board_record.taskboard_id;
    END LOOP;
END $$;
...
SELECT 'Sample taskboards:' as info;
